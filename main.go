...
func main() {
	...
	token := flag.String("t", "8kUFNBmnwqlBYtjNT4HGm3gM5iQaTt6q", "qq api token")
	appid := flag.String("a", "102033405", "qq appid")
	secret := flag.String("s", "Ts55sSpytb5LNCnA", "qq secret")
